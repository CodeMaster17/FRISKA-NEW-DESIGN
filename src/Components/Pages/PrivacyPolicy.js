...
function PrivacyPolicy() {
    return (
        <div className="PrivacyOuterContainer">
            <div className="PrivacyHeroContainer">
                <p className="topMostPrivacyHeading">FRISKA</p>
                <h1 className="privacyHeading">Privacy Policy</h1>
            </div>
            <div className="privacyPolicyPara">
                <p className="paraPrivacy">
                    Privacy Policy
                    Last updated: ___________, 2022
                    ...
                    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FRISKA, Pune, India.
                    ...
                    Website refers to FRISKA, accessible from https://friskanow.com/
                    ...
                    By email: support@friskanow.com
                    By phone number: +91 8983176450
